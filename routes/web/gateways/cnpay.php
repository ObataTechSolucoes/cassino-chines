...
Route::prefix('cnpay')
    ->group(function () {
        ...
        // Callbacks de saque
        Route::post('withdraw/callback', [CNPayController::class, 'withdrawCallback']);
        Route::post('affiliate-withdraw/callback', [CNPayController::class, 'affiliateWithdrawCallback']);
