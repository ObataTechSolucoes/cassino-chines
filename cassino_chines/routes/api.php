...
Route::middleware(['auth:api'])->group(function () {
    Route::post('api/games/spin-wheel', [GameController::class, 'spinWheel']);
});
...
Route::prefix('cnpay')->group(function () {
    include_once(__DIR__ . '/api/cnpay.php');
});
...
include_once(__DIR__ . '/groups/api/gateways/ezzepay.php');
include_once(__DIR__ . '/groups/api/gateways/cnpay.php');
