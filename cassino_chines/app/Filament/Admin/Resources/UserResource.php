                ...
                Forms\Components\Section::make()
                    ->schema([
                        ...
                        Forms\Components\Toggle::make('is_demo_agent')
                            ->label('Influender gameslot')
                            ->columnSpanFull()
                        ,
                        Forms\Components\Toggle::make('influencer_mode')
                            ->label('Modo Influencer ativa 10 jogos com RTP ALTO')
                            ->columnSpanFull()
                        ,
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    // Sistema de exclusão com confirmação de senha
