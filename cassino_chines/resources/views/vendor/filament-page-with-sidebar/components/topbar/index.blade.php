...
<div class="mt-8 filament-page-with-sidebar-topbar">
    <nav role="navigation" aria-label="Sub navegação" class="flex items-center w-full gap-x-3 px-3 py-2 rounded-xl overflow-x-auto">
        @if ($sidebar->getTitle() != null || $sidebar->getDescription() != null)
            <div class="me-6 hidden lg:flex flex-col min-w-[12rem]">
