...
class AffiliateController extends Controller
{
    public function index()
    {
        ...
        for ($i = 1; $i <= 40; $i++) {
            ...
            if ($bau) {
                $chestImages[$i] = $this->assetPath($bau->caminho);
            } else {
                $chestImages[$i] = asset('assets/images/baulock.png'); // Caminho padrão (URL completa)
            }
        }
    ...
    private function getCaminhoImagem($bau)
    {
        if ($bau) {
            switch ($bau->status) {
                case 2:
                    return asset('assets/images/bauliberado.png');
                case 3:
                    return asset('assets/images/bauaberto.png');
                default:
                    return asset('assets/images/baulock.png');
            }
        } else {
            return asset('assets/images/baulock.png');
        }
